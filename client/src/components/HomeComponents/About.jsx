    ...
    <section id="about" className="mt-10 py-16">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center text-center md:text-left space-y-4">
          <p className="text-sm uppercase tracking-widest text-secondaryText">
            Hello, I am
          </p>
          <h1 className="text-5xl lg:text-7xl font-bold leading-[1.1] tracking-tight text-accentColor font-fontHeading glow-text">
            {name}
          </h1>
          {/* <h1 className="text-4xl font-extrabold text-accentColor ">{name}</h1> */}
          <h2 className="text-xl font-semibold text-primaryText">
            Full Stack Developer
          </h2>
          <p className="text-secondaryText leading-relaxed mt-2">
